    ...
    <div class="bg-white rounded-xl shadow-sm hover:shadow-md transition-all duration-300 border border-gray-100 overflow-hidden group">
        <div class="p-4">
            <div class="flex items-center justify-between mb-2">
                ...
                <span class="text-xl font-bold text-[#B08968]">Rp 89.5jt</span>
            </div>
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
    ...
    <div class="lg:col-span-2 bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="px-4 py-3 border-b border-gray-100 flex justify-between items-center">
            ...
            <a href="#" class="text-xs text-[#B08968] hover:text-[#8B6F4F] transition">Lihat Semua →</a>
        </div>
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-100">
                    <tr class="hover:bg-gray-50 transition">
                        <td class="px-4 py-3 text-xs font-medium text-gray-900">#INV-001</td>
                        <td class="px-4 py-3 text-xs text-gray-600">Budi Santoso</td>
                        <td class="px-4 py-3 text-xs font-semibold text-[#B08968]">Rp 2.500.000</td>
                        <td class="px-4 py-3">
                            <span class="px-1.5 py-0.5 text-[10px] rounded-full bg-yellow-100 text-yellow-700">Diproses</span>
                        </td>
                    </tr>
                    <tr class="hover:bg-gray-50 transition">
                        <td class="px-4 py-3 text-xs font-medium text-gray-900">#INV-002</td>
                        <td class="px-4 py-3 text-xs text-gray-600">Siti Aminah</td>
                        <td class="px-4 py-3 text-xs font-semibold text-[#B08968]">Rp 4.200.000</td>
                        <td class="px-4 py-3">
                            <span class="px-1.5 py-0.5 text-[10px] rounded-full bg-green-100 text-green-700">Selesai</span>
                        </td>
                    </tr>
                    <tr class="hover:bg-gray-50 transition">
                        <td class="px-4 py-3 text-xs font-medium text-gray-900">#INV-003</td>
                        <td class="px-4 py-3 text-xs text-gray-600">Ahmad Fauzi</td>
                        <td class="px-4 py-3 text-xs font-semibold text-[#B08968]">Rp 1.800.000</td>
                        <td class="px-4 py-3">
                            <span class="px-1.5 py-0.5 text-[10px] rounded-full bg-blue-100 text-blue-700">Dikirim</span>
                        </td>
                    </tr>
                    <tr class="hover:bg-gray-50 transition">
                        <td class="px-4 py-3 text-xs font-medium text-gray-900">#INV-004</td>
                        <td class="px-4 py-3 text-xs text-gray-600">Dewi Lestari</td>
                        <td class="px-4 py-3 text-xs font-semibold text-[#B08968]">Rp 3.100.000</td>
                        <td class="px-4 py-3">
                            <span class="px-1.5 py-0.5 text-[10px] rounded-full bg-gray-100 text-gray-600">Pending</span>
                        </td>
                    </tr>
                </tbody>
            </table>
    ...
    <div class="space-y-4">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
            ...
            <div class="space-y-2">
                <div class="flex justify-between items-center">
                    <span class="text-xs text-gray-600">Kursi Tamu Jati</span>
                    <span class="text-xs font-medium text-red-500">Stok: 3</span>
                </div>
                <div class="flex justify-between items-center">
                    <span class="text-xs text-gray-600">Meja Makan Marmer</span>
                    <span class="text-xs font-medium text-red-500">Stok: 5</span>
                </div>
                <div class="flex justify-between items-center">
                    <span class="text-xs text-gray-600">Lemari Pakaian</span>
                    <span class="text-xs font-medium text-red-500">Stok: 2</span>
                </div>
            </div>
            <a href="#" class="mt-3 inline-block text-xs text-[#B08968] hover:text-[#8B6F4F] transition">Kelola Stok →</a>
        </div>
        ...
        <div class="bg-gradient-to-r from-[#B08968] to-[#8B6F4F] rounded-xl shadow-md p-4 text-white">
            ...
            <div class="space-y-1.5">
                <a href="#" class="flex items-center gap-2 text-white/90 hover:text-white transition group text-sm">
