...
@section('content')
    ...
    <div class="bg-gradient-to-b from-gray-50 to-white py-6">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="w-12 h-0.5 bg-[#B08968] mx-auto mt-2.5 rounded-full"></div>
        </div>
    </div>
    ...
    <div class="bg-white py-6">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
                <!-- Email Card -->
                <div class="bg-gray-50 rounded-lg p-4 text-center hover:shadow-md transition-all duration-300 hover:-translate-y-0.5 group">
                    <div class="w-10 h-10 bg-[#B08968]/10 rounded-full flex items-center justify-center mx-auto mb-2 group-hover:bg-[#B08968] transition-colors duration-300">
                    ...
                    <h3 class="text-xs font-semibold text-gray-800 mb-0.5">Email</h3>
                ...
                <!-- Alamat Card -->
                <div class="bg-gray-50 rounded-lg p-4 text-center hover:shadow-md transition-all duration-300 hover:-translate-y-0.5 group md:col-span-2 lg:col-span-1">
                    <div class="w-10 h-10 bg-[#B08968]/10 rounded-full flex items-center justify-center mx-auto mb-2 group-hover:bg-[#B08968] transition-colors duration-300">
                        <svg class="w-5 h-5 text-[#B08968] group-hover:text-white transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <h3 class="text-xs font-semibold text-gray-800 mb-0.5">Alamat</h3>
                ...
                <div class="bg-gray-50 rounded-lg p-4 text-center hover:shadow-md transition-all duration-300 hover:-translate-y-0.5 group">
                    ...
                    <h3 class="text-xs font-semibold text-gray-800 mb-0.5">Telepon</h3>
                    <a href="tel:082231289379" class="text-[#B08968] hover:text-[#8B6F4F] text-xs">
                        0822-3128-9379
                    </a>
                </div>
                ...
                <div class="bg-gray-50 rounded-lg p-4 text-center hover:shadow-md transition-all duration-300 hover:-translate-y-0.5 group">
                    ...
                    <h3 class="text-xs font-semibold text-gray-800 mb-0.5">Instagram</h3>
    ...
    <div class="bg-gray-50 py-6">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-lg shadow-sm overflow-hidden">
                ...
                <div class="p-2.5 bg-white border-t border-gray-100 text-center">
