...
@section('content')
    ...
    <div class="relative bg-gradient-to-r from-[#B08968]/5 via-white to-[#8B6F4F]/5 overflow-hidden">
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center min-h-[450px] py-8 lg:py-12">
                <!-- Left Column -->
                <div class="text-center lg:text-left space-y-5 reveal" data-delay="0">
                    <!-- Badge -->
                    <span class="inline-block px-3 py-1 bg-[#B08968]/10 text-[#B08968] rounded-full text-xs font-semibold tracking-wide">
                        ✦ Furniture Custom ✦
                    </span>
                    ...
                    <!-- Description -->
                    <p class="text-sm text-gray-600 leading-relaxed max-w-xl mx-auto lg:mx-0">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
                        <a href="{{ route('katalog') }}" 
                           class="group relative inline-flex items-center justify-center gap-2 bg-[#B08968] text-white px-5 py-2 rounded-full font-semibold overflow-hidden transition-all duration-300 hover:shadow-xl hover:scale-105 text-sm">
                        ...
                        <a href="{{ route('kontak') }}" 
                           class="group inline-flex items-center justify-center gap-2 border-2 border-[#B08968] text-[#B08968] px-5 py-2 rounded-full font-semibold hover:bg-[#B08968] hover:text-white transition-all duration-300 text-sm">
    ...
    <!-- PROSES PEMESANAN - ✅ TAMBAHKAN ID DI SINI -->
