...
<div class="bg-gray-50 border-b border-gray-200">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div class="flex items-center gap-2 text-sm">
            ...
            <span class="text-gray-400">/</span>
            <a href="{{ route('produk.detail', $produk->slug) }}" class="text-gray-500 hover:text-[#B08968]">{{ $produk->nama_produk }}</a>
            <span class="text-gray-400">/</span>
            <span class="text-[#B08968] font-medium">Checkout</span>
        </div>
    </div>
</div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div class="flex items-center justify-center gap-4 md:gap-8">
            ...
            <div class="flex items-center gap-2">
                <div class="w-8 h-8 bg-[#B08968] text-white rounded-full flex items-center justify-center font-semibold">1</div>
                <span class="font-medium text-[#B08968]">Alamat</span>
            </div>
            ...
            <div class="flex items-center gap-2">
                ...
                <span class="font-medium text-gray-500">Pengiriman</span>
            </div>
            <div class="w-12 h-0.5 bg-gray-300"></div>
        ...
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100">
            ...
            <div class="px-6 py-4 bg-gray-50 border-b border-gray-200">
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-sm text-gray-500">Rp {{ number_format($produk->harga, 0, ',', '.') }} (estimasi /meter)</p>
                    </div>
                </div>
            </div>
            ...
            <div class="px-6 py-3 bg-amber-50 border-b border-amber-100">
                <div class="flex items-center gap-2 text-amber-700">
                    ...
                    <p class="text-sm font-medium">Harga final akan ditentukan setelah survey dan pengukuran oleh tim kami.</p>
                </div>
            </div>
            
            <!-- Form -->
            <form action="{{ route('pesan.store.alamat') }}" method="POST" class="p-6">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" 
                               ...
                               required
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#B08968] focus:border-transparent transition"
                    ...
                    <!-- Kota -->
                    <div>
                        <label for="kota" class="block text-sm font-medium text-gray-700 mb-1">Kota <span class="text-red-500">*</span></label>
                        <input type="text" 
                               id="kota" 
                               name="kota" 
                               value="{{ old('kota') }}"
                    ...
                    <!-- Alamat Lengkap -->
                    <div class="md:col-span-2">
                        <label for="alamat_lengkap" class="block text-sm font-medium text-gray-700 mb-1">Alamat Lengkap <span class="text-red-500">*</span></label>
                ...
                <div class="mt-6 p-4 bg-gray-50 rounded-lg">
                    <div class="flex items-start gap-3">
                        <svg class="w-5 h-5 text-[#B08968] mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                        </svg>
                        <div>
                            <p class="text-sm font-medium text-gray-700">Jadwal Survey</p>
                            <p class="text-xs text-gray-500 mt-1">Tim kami akan menghubungi Anda via WhatsApp dalam 1x24 jam untuk menentukan jadwal survey dan pengukuran.</p>
                        </div>
                    </div>
                </div>
