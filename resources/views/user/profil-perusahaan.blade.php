    ...
    <div class="bg-gray-50 py-12">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                @php
                    $advantages = [
                        ['icon' => 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z', 'title' => 'Material Berkualitas', 'desc' => 'Material pilihan dengan standar kualitas terbaik'],
                        ['icon' => 'M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z', 'title' => 'Custom Desain', 'desc' => 'Bebas menentukan desain sesuai keinginan'],
                        ['icon' => 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z', 'title' => 'Pengerjaan Rapi', 'desc' => 'Detail teliti dengan finishing sempurna'],
                        ['icon' => 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z', 'title' => 'Harga Kompetitif', 'desc' => 'Harga bersaing dengan kualitas terbaik'],
                        ['icon' => 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z', 'title' => 'Tim Berpengalaman', 'desc' => 'Profesional yang berpengalaman di bidangnya'],
                        ['icon' => 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6', 'title' => 'Jangkauan Layanan', 'desc' => 'Melayani Jawa Timur dan sekitarnya'],
                    ];
                @endphp
                @foreach($advantages as $adv)
                <div class="bg-white rounded-lg p-4 shadow-sm border border-gray-100 hover:shadow-md hover:-translate-y-0.5 transition-all duration-300">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        ...
                        <div class="flex items-center gap-2 p-2.5 bg-gray-50 rounded-lg border border-gray-100 hover:border-[#B08968]/30 transition-colors group">
                ...
                <div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex items-center gap-3 p-2.5 bg-gray-50 rounded-lg border border-gray-100 group hover:border-[#B08968]/30 transition-all">
