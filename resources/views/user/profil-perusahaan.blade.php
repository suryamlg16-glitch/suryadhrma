        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                ...
                <div class="relative order-first lg:order-last">
                    <div class="rounded-xl shadow-md overflow-hidden aspect-video">
    ...
    <div class="bg-gray-50 py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
                <!-- Keunggulan 1 -->
                <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100 hover:shadow-md hover:-translate-y-0.5 transition-all duration-300">
                    <div class="w-9 h-9 bg-[#B08968]/10 rounded-full flex items-center justify-center mb-2">
                        <svg class="w-4 h-4 text-[#B08968]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                        </svg>
                    </div>
                    <h3 class="text-sm font-semibold text-gray-800 mb-1">Material Berkualitas</h3>
                ...
                <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100 hover:shadow-md hover:-translate-y-0.5 transition-all duration-300">
                    ...
                    <h3 class="text-sm font-semibold text-gray-800 mb-1">Custom Desain</h3>
                ...
                <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100 hover:shadow-md hover:-translate-y-0.5 transition-all duration-300">
                    ...
                    <h3 class="text-sm font-semibold text-gray-800 mb-1">Pengerjaan Rapi</h3>
                ...
                <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100 hover:shadow-md hover:-translate-y-0.5 transition-all duration-300">
                    ...
                    <h3 class="text-sm font-semibold text-gray-800 mb-1">Harga Kompetitif</h3>
                ...
                <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100 hover:shadow-md hover:-translate-y-0.5 transition-all duration-300">
                    ...
                    <h3 class="text-sm font-semibold text-gray-800 mb-1">Tim Berpengalaman</h3>
                ...
                <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100 hover:shadow-md hover:-translate-y-0.5 transition-all duration-300">
                    ...
                    <h3 class="text-sm font-semibold text-gray-800 mb-1">Area Layanan Luas</h3>
    ...
    <div class="bg-white py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <!-- Layanan Kami -->
                <div>
                    <h2 class="text-lg font-bold text-gray-900 mb-1 pb-2 border-b-2 border-[#B08968] inline-block">
                        Layanan Kami
                    </h2>
    ...
    <div class="bg-gray-50 py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
                <h2 class="text-lg font-bold text-gray-900 mb-1">Area Layanan</h2>
                <div class="w-10 h-0.5 bg-[#B08968] mb-3 rounded-full"></div>
