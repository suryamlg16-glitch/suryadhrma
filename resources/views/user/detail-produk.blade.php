...
<div class="bg-white py-8 md:py-10">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10">
            ...
            <div class="space-y-4">
                <!-- Kategori -->
                <span class="inline-block px-3 py-1 bg-[#B08968]/10 text-[#B08968] text-xs font-medium rounded-full">
                ...
                <div class="flex items-baseline gap-2">
                    <p class="text-3xl md:text-4xl font-bold text-[#B08968]">
                        Rp {{ number_format($produk->harga ?? 0, 0, ',', '.') }}
                    </p>
                    <p class="text-gray-400 text-sm">/meter lari (estimasi)</p>
                </div>
                ...
                <div class="bg-blue-50 border border-blue-100 rounded-lg p-3">
                    <div class="flex gap-2">
                        ...
                        <div>
                            <p class="text-xs text-blue-800 font-medium">Furniture Custom Sesuai Ukuran</p>
                            <p class="text-[11px] text-blue-600 mt-0.5">Harga dapat berubah sesuai ukuran, bahan, dan tingkat kerumitan. Tim kami akan survey dan mengukur langsung di lokasi.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 rounded-lg p-4">
                    <h3 class="text-sm font-semibold text-gray-900 mb-3">Spesifikasi & Material</h3>
                    <div class="grid grid-cols-2 gap-3">
                        <div>
                            <p class="text-[11px] text-gray-500">Material Utama</p>
                            <p class="text-sm font-medium text-gray-800">{{ $produk->bahan ?? 'Kayu Jati' }}</p>
                        </div>
                        <div>
                            <p class="text-[11px] text-gray-500">Finishing</p>
                            <p class="text-sm font-medium text-gray-800">Melamin / Cat Duco</p>
                        </div>
                        <div>
                            <p class="text-[11px] text-gray-500">Warna</p>
                            <p class="text-sm font-medium text-gray-800">{{ $produk->warna ?? 'Natural / Custom' }}</p>
                        </div>
                        <div>
                            <p class="text-[11px] text-gray-500">Garansi</p>
                            <p class="text-sm font-medium text-gray-800">1 Tahun</p>
                        </div>
                    </div>
                </div>
...
<div class="pt-3 space-y-3">
    ...
    <a href="{{ route('pesan.index', ['slug' => $produk->slug]) }}"
       class="w-full flex items-center justify-center gap-2.5 py-3.5 px-5 rounded-xl bg-[#B08968] hover:bg-[#9A7357] active:bg-[#8B6448] text-white text-sm font-medium tracking-wide transition-colors duration-200">
        ...
        Buat Pesanan
                ...
                target="_blank"
                class="w-full flex items-center justify-center gap-2.5 py-3.5 px-5 rounded-xl border border-[#3a7d4e] text-[#3a7d4e] hover:bg-[#f0f8f3] active:bg-[#e2f2e8] text-sm font-medium tracking-wide transition-colors duration-200">
                    <svg class="w-[17px] h-[17px] flex-shrink-0" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
